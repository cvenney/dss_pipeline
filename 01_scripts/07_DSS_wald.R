...
#srun -c 5 --mem 150G -p small --time 1-00:00:00 -J 07_DSS -o 07_DSS_wald_%j.log Rscript ./01_scripts/07_DSS_wald.R &
...
p_val=0.001
delta=0.15	# minimum percent difference in methylation between groups
min_len=200
min_CGs=10
merge_distance=50
pct_sig_CGs=0.5
